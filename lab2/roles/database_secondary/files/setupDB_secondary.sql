...
CREATE USER 'pc'@'%' IDENTIFIED WITH mysql_native_password BY 'petclinic';
...
CHANGE MASTER TO MASTER_HOST='database-primary', MASTER_PORT=DATABASEPRIMARYPORT, MASTER_USER='pc', MASTER_PASSWORD='petclinic';
START SLAVE;
